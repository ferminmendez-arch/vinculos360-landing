...
export default function LandingVinculos360() {
  const logoSrc = "/logo-vinculos360.png";
  const familyImageSrc = "/familia-factura.png";
  const whatsappLink = "https://wa.me/13466385556";
  const phoneLink = "tel:+13466385556";

  const steps = [
    {
      number: "01",
      title: "Regístrate gratis",
      description: "Completa un formulario rápido y cuéntanos qué servicios quieres revisar.",
    },
    {
      number: "02",
      title: "Revisamos tus opciones",
      description: "Analizamos alternativas en energía, internet, telefonía y más para ti.",
    },
    {
      number: "03",
      title: "Te guiamos paso a paso",
      description: "Te explicamos el proceso de forma clara para que tomes la mejor decisión.",
    },
    {
      number: "04",
      title: "Empieza a ahorrar",
      description: "Activa el cambio y comienza a ver resultados en tus servicios esenciales.",
    },
  ];
  ...
  const testimonials = [
    {
      name: "María G.",
      role: "Houston, TX",
      text: "Me ayudaron a entender mis opciones y ahora pago menos en mis servicios sin complicaciones.",
      stars: 5,
    },
    {
      name: "Hector H.",
      role: "Pecos, TX",
      text: "El proceso fue rápido, claro y muy profesional. Excelente atención desde el primer mensaje.",
      stars: 5,
    },
    {
      name: "Ana L.",
      role: "Austin, TX",
      text: "Me encantó que todo se explicó de forma sencilla. Ahora tengo más control de mis gastos.",
      stars: 5,
    },
  ];

  const miniBenefits = ["Atención en español", "Evaluación gratuita", "Proceso rápido y sencillo"];
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-full bg-white shadow-sm ring-1 ring-slate-200 sm:h-14 sm:w-14">
              <img src={logoSrc} alt="Vínculos 360" className="h-full w-full object-contain p-0.5" />
            </div>
            <div>
          ...
          <nav className="hidden items-center gap-8 md:flex">
            ...
            <a href="#como-funciona" className="text-sm font-medium text-slate-700 hover:text-sky-600">
              Cómo Funciona
            </a>
            <a href="#testimonios" className="text-sm font-medium text-slate-700 hover:text-sky-600">
              Testimonios
            </a>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 rounded-full bg-sky-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-sky-700 hover:shadow-md"
          >
      ...
      <main>
        <section id="inicio" className="relative overflow-hidden bg-gradient-to-b from-white via-sky-50/40 to-white">
